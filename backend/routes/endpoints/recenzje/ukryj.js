...
async function ukryjRecenzje(req, res) {
  try {
    ...
    const zaktualizowanaRecenzja = await ustawStatusRecenzji(id, "ukryta");
...
router.patch("/:id", ukryjRecenzje);
router.put("/:id", ukryjRecenzje);
